...
public class VideoController {
	...
	public ResponseDTO<GetVideosResponseDTO> getVideosForAllLocations() {
		...
		try {
			...
			GetVideosResponseDTO videosResponse = coursesExplorationService.fetchVideos(null, errorList);
	...
	@GetMapping(value = {UrlConstants.DEFAULT_VIDEO_URL, UrlConstants.VIDEO_URL}, produces = "application/json")
